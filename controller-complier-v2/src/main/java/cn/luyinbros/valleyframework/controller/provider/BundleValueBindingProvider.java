...
public class BundleValueBindingProvider {
    ...
    public List<BundleValueBinding> getBundleValueBindings() {
        return bundleValueBindings;
    }
...
//    }
    ...
    public static String getInvokeMethodName(ControllerType type, TypeMirror typeMirror) {
        TypeKind kind = typeMirror.getKind();
        if (type == ControllerType.ACTIVITY) {
            if (kind.isPrimitive()) {
