...
public class Constants {
    public static final String PACKAGE_CONTROLLER_LIBRARY = "cn.luyinbros.valleyframework.controller";
    ...
    public static final String TYPE_VIEW_MODEL = "androidx.lifecycle.ViewModel";
